...
# LateralCluster canonical definition lives in mpc_packs.lateral_cluster
# (carved Session 9). Re-exported here so Session-3-era callers resolve
# the same class object.
from mpc_packs.lateral_cluster.pack import LateralCluster  # noqa: E402,F401
